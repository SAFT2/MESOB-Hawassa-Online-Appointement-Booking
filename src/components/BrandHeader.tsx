...
export default function BrandHeader() {
  ...
  {user && !isStaff && (
    <Link to="/my-appointments" className="hidden sm:inline-block px-3 py-1.5 text-sm font-semibold text-white/90 hover:text-white">{t("nav_history")}</Link>
  )}
  ...
  {user && (
    <div className="flex items-center gap-2">
      ...
      {!isStaff && (
        <Link to="/my-appointments" className="sm:hidden">
          <Button size="sm" variant="secondary" className="bg-white/15 text-white hover:bg-white/25 border-white/20">
